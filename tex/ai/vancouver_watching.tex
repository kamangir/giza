...
\keyword{vanwatch detect} runs object detection algo~\cite{ultralytics} on the images ingested into \keyword{<object-name>} and updates \keyword{<target>.geojson}\footnote{refer to \url{https://github.com/kamangir/bluer-south} for more examples.}.
%
\begin{graybox}
\begin{verbatim}
vanwatch \
