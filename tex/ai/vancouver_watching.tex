...
\keyword{vanwatch}~\cite{vanwatch} is a callable that discovers traffic cameras in a target, ingests images from them, and runs detection algo on the image to generate time series analytics.
