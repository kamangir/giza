...
\texttt{@openai}~\footurl{https://github.com/kamangir/openai\_cli} is a bash cli for the OpenAI API~\footurl{https://beta.openai.com/docs/introduction}. \texttt{@openai} is a \keywordd{callable}{callables} that supports basic prompt completion through,
%
\begin{verbatim}
