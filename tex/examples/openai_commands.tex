...
\texttt{@openai}~\cite{openai_commands} is a bash cli for the OpenAI API~\cite{openai_api}. \texttt{@openai} is a \kCallable that supports basic prompt completion through,
%
\begin{verbatim}
