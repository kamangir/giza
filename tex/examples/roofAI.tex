...
\texttt{roofAI dataset ingest source=AIRS|CamVid <object-name>} ingests a dataset into \texttt{<object-name>} and tags it for future discovery. \texttt{roofAI dataset review - <object-name>} reviews the dataset in \texttt{<object-name>}.
%
\begin{verbatim}
