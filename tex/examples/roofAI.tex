\subsection{\texttt{roofAI}}\label{roofAI}

\texttt{roofAI}~\footurl{https://github.com/kamangir/roofAI} is a \keyword{callable} that,
%
\begin{enumerate}
...
\subsubsection{\texttt{roofAI dataset}}\label{roofAI_dataset}
...
\subsubsection{\texttt{roofAI semseg train}}\label{roofAI_semseg_train}
...
\subsubsection{\texttt{roofAI semseg predict}}\label{roofAI_semseg_predict}
