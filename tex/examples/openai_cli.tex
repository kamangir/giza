\subsection{\texttt{openai-cli}}

\texttt{openai-cli}~\footurl{https://github.com/kamangir/openai_cli} is a bash cli for the OpenAI API~\footurl{https://beta.openai.com/docs/introduction}. \texttt{openai_cli} is a \keywordd{callable}{callables} that supports basic prompt completion through,
%
\begin{verbatim}
...
\end{verbatim}
%
The Vision API~\footurl{https://platform.openai.com/docs/guides/vision} is supported,
%
\begin{verbatim}
