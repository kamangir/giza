...
Two \keyword{objects} can be related in several ways, each defined as a pair, to enable directional relations~\citeabcli{abcli/plugins/relations/relations.json}. Here is an example,
%
\begin{verbatim}
{
    "added-to": "contains",
