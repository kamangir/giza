\subsection{\texttt{@relations}}
\label{relations}

Two objects~\ref{objects} can be related in several ways, each defined as a pair, to enable directional relations~\footabcli{abcli/plugins/relations/relations.json}. Here is an example,
%
\begin{verbatim}
{
    "added-to": "contains",
