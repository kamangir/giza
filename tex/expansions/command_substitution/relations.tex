...
Two objects can be related in a number of ways, each defined as a pair, to enable directional relations~\footurl{https://github.com/kamangir/awesome-bash-cli/blob/main/abcli/plugins/relations/relations.json}. Here is an example,
%
\begin{verbatim}
{
    "added-to": "contains",
