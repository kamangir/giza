...
\end{verbatim}
%
It is recommended that additional \keyword{download} and \keyword{list} expansions are defined for typed objects. See \keyword{hubble} for examples. Objects can be cloned,
%
\begin{verbatim}
