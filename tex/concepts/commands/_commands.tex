...
A \emph{command} is any Bash command~\cite{shell_sytax} and can be represented in a Python string of characters~\cite{python_string}. Here is an example command,
%
\begin{verbatim}
vanwatch ingest \
    vancouver \
