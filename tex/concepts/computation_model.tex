...
A group of operators create and maintain the \keyword{core} and the \keyword{plugins} as one or more repositories, using a system such as \keyword{git}. Each operator can access a set of machines and create shells on them. Each operator can also access a set of repositories and clone them on the machines where they create shells and receive updates. The operator can modify any of the repositories that they have access to following a collective peer-reviewed \texttt{pull-request}~\cite{pull_request} process.
