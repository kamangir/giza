...
A group of \keyword{operators} create and maintain the \keyword{core} and the \keyword{plugins} as one or more repositories, using a system such as \keyword{git}. Each operator can access a set of \keyword{machines} and create \keyword{shells} on them to run \keyword{commands}. 
