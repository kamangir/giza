...
A group of \keyword{operator}s create and maintain the \keyword{core} and the \keyword{plugins} as one or more repositories, using a system such as \keyword{git}. Each operator can access a set of \keyword{machine}s and create \keyword{shell}s on them to run \keyword{commands}. 
